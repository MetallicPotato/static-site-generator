...
class TestTextNode(unittest.TestCase):
    ...
    def test_link(self):
        node = TextNode("this is text!", TextType.LINK, "https://www.google.com")
        html_node = text_node_to_html_node(node)
    ...
    def test_image(self):
        node = TextNode("this is text!", TextType.IMAGE, "https://www.google.com")
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "img")
        self.assertEqual(html_node.props["alt"], "this is text!")
